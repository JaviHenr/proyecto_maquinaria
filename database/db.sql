/* CREATE DATABASE proyecto_maquinaria; */
...
CREATE TABLE PERSONAL_MANTENCION_EXTERNA (
    ...
    NOMBRE_PERSONAL_MANTENCION VARCHAR(50),
    NOMBRE_EMPRESA_MANTENCION VARCHAR(50),
    CARGO_PERSONAL_MANTENCION VARCHAR(20),
...
CREATE TABLE PERSONAL_LABORATORIO (
    ...
    NOMBRE_PERSONAL_LABORATORIO VARCHAR(50),
    CARGO_PERSONAL_LABORATORIO VARCHAR(20),
...
CREATE TABLE TIENE (
    ID_ACTIVO_M VARCHAR(15),
    ID_MANTENCION INT,
    PIEZAS_MAQUINARIA_MANTENCION VARCHAR(200),
...
CREATE TABLE MANEJA (
    ID_ACTIVO_M VARCHAR(15),
    RUT_CLIENTE VARCHAR(12),
    FECHA_USO_MAQUINARIA DATE,
    HORA_LLEGADA_USO_MAQUINARIA TIME,
    DESCRIPCION_USO_MAQUINARIA VARCHAR(150),
    HORA_SALIDA_USO_MAQUINARIA TIME,
    PRIMARY KEY (ID_ACTIVO_M, RUT_CLIENTE),
    FOREIGN KEY (ID_ACTIVO_M) REFERENCES MAQUINARIA(ID_ACTIVO_M),
...
CREATE TABLE USA (
    ...
    DESCRIPCION_USO_SALA VARCHAR(150),
...
CREATE TABLE UTILIZA (
    RUT_CLIENTE VARCHAR(12),
    ID_ACTIVO_H INT,
    FECHA_USO_HERRAMIENTA DATE,
    HORA_LLEGADA_HERRAMIENTA TIME,
    HORA_SALIDA_HERRAMIENTA TIME,
    DESCRIPCION_USO_HERRAMIENTA VARCHAR(150),
    PRI   MARY KEY (RUT_CLIENTE, ID_ACTIVO_H),
    FOREIGN KEY (RUT_CLIENTE) REFERENCES CLIENTE(RUT_CLIENTE),
    FOREIGN KEY (ID_ACTIVO_H) REFERENCES HERRAMIENTA(ID_ACTIVO_H)
);
