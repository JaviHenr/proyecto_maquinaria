...
export const getReservaMaquinariasRequest = async () =>
  await axios.get("http://localhost:4000/reserva_maquinarias"); 
...
export const createReservaMaquinariaRequest = async (reservaMaquinaria) =>
    await axios.post("http://localhost:4000/reserva_maquinaria", reservaMaquinaria);
...
export const deleteReservaMaquinariaRequest = async (id) =>
    await axios.delete(`http://localhost:4000/reserva_maquinaria/${id}`);
...
export const getReservaMaquinariaRequest = async (id) =>
    await axios.get(`http://localhost:4000/reserva_maquinaria/${id}`);
...
export const updateReservaMaquinariaRequest = async (id, reservaMaquinaria) =>
    await axios.put(`http://localhost:4000/reserva_maquinaria/${id}`, reservaMaquinaria);
